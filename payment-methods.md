...
Then, the first step in setting up a Payment Method is to tick your enterprise, in the box on the right hand side of the page titled Hubs.  This indicates which enterprise the payment method you are about to create will apply to. You can select more than one enterprise.
...
**Description:** Here you can provide further details about the payment method. For example, for a bank transfer, you would provide details of the bank account. This description will be displayed at checkout and in order confirmation emails. A screenshot showing how payment methods display at checkout is shown below. The customer has selected ‘cash on collection/delivery’ and the ‘correct change…’ description is displayed.
